...
# 这个click其实和另一个文件中的argparse是一样的， 都是用来解析命令行参数的，
# 最大的区别就是click的语法更加简洁， 更加pythonic(就是更'python'的意思)， 但是功能上来说， 两者是一样的
# “@” 在python中叫做装饰器， 用来为函数添加额外的功能， 这里的@click.command()就是一个装饰器
